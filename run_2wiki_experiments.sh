...
echo "$(date): Starting 2Wiki ReAct-KV (TOVA) experiment..."
$PYTHON $SCRIPT --experiment react_kv_tova > "${LOGDIR}/logs_react_kv_tova_2wiki.log" 2>&1
echo "$(date): 2Wiki ReAct-KV (TOVA) done."
